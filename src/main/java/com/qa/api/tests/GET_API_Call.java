...
public class GET_API_Call {
	...
	public void getSpecificUserApiTest() {
		...
		AssertJUnit.assertEquals(apiResponse.ok(), true);
	...
	public void getUsersApiTest() throws IOException {
		...
		AssertJUnit.assertEquals(headerMap.get("content-type"), "application/json; charset=utf-8");
		AssertJUnit.assertEquals(headerMap.get("x-download-options"), "noopen");
